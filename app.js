      ...
      <div class="auth-card">
        ...
        <div class="role-selector">
          ...
          <button class="role-btn" data-role="Wali Kelas" onclick="selectRole('Wali Kelas')">
            <i class="bi bi-person-workspace"></i> Wali Kelas
          </button>
    ...
    <div class="dashboard-container">
      <div class="sidebar">
        ...
        <ul class="sidebar-menu">
          ...
          <li><a href="#" onclick="showTabSiswa('gantipassword'); return false;"><i class="bi bi-key"></i> Ganti Password</a></li>
        </ul>
      </div>
      ...
      <div class="bottom-nav">
        <ul class="bottom-nav-menu">
          ...
          <li><a href="#" onclick="showTabMobileSiswa('cetakqr'); return false;"><i class="bi bi-printer"></i><span>QR</span></a></li>
        </ul>
      </div>
    </div>
  `;
